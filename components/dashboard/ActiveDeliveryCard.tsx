...
export const ActiveDeliveryCard = ({
  ...
  const pickupAddress = `${inProgressDelivery.provincia.nombre}, ${
    inProgressDelivery.municipio.nombre
  }, ${inProgressDelivery.origin?.nombre || ""}, ${
    inProgressDelivery.deliveryAddress
  }`;

  // Construir dirección de entrega (solo para DELIVERY)
  const deliveryAddress =
    inProgressDelivery.type === AssignmentType.DELIVERY
      ? `${inProgressDelivery.provincia.nombre}, ${
          inProgressDelivery.municipio.nombre
        }, ${inProgressDelivery.destiny?.nombre || ""}, ${
          inProgressDelivery.deliveryAddress
        }`
      : "";
          ...
          >
            ...
            <View style={styles.actionRow}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  openWhatsAppMessage(
                    inProgressDelivery.phone,
                    `Hola ${inProgressDelivery.client}`
                  )
                }
                activeOpacity={0.8}
                accessibilityRole="button"
