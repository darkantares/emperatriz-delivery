  ...
  useEffect(() => {
    ...
    if (isVisible) {
      ...
      Promise.all([loadStatuses(), loadPaymentMethods()]).then(() => {
        ...
        if (
          currentStatusAsEnum &&
          validStatusTransitions[currentStatusAsEnum]
        ) {
                ...
                {availableStatuses.length > 0 ? (
                  ...
                  <View style={styles.noStatusesContainer}>
                    <Text style={styles.noStatusesText}>
                      No hay estados disponibles para progresión. Este es un
                      estado final.
                    </Text>
                  </View>
                )}
                ...
                {isPickupType && (
                  <View style={styles.pickupNoteContainer}>
                    <Text style={styles.pickupNoteText}>
                      Para recogidas (PICKUP) no se requiere evidencia
                      fotográfica.
                    </Text>
                  </View>
                )}
